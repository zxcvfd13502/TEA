...
from data.clear10 import Clear10
from data.clear100 import Clear100
from typing import Union


class WrappedDataset(Dataset):
    def __init__(self, args, dataset: Union[Yearbook, RotatedMNIST, Clear10, Clear100]):
        self.args = args
    ...
    def process_datasets(self, dataset: Union[Yearbook, RotatedMNIST, Clear10, Clear100]):
        train_val_split = []
        all_data = []
        all_label = []

...
class Clear100Base(Dataset):
    def __init__(self, args):
        ...
        args.defrost()
        args.class_list = 'airplane amusement_park anime aquarium backpack baseball basketball bathroom beer bicycle billard billboard blackboard boat bookstore bowling_ball bridge bus camera canned_food casino castle chef chocolate church coins coser diving farm ferry field_hockey firefighter food_truck football fountain gallery garage glasses gloves golf graffiti guitar gym hair_salon hat helicopter highway horse_riding ice_cream ice_hockey ice_skating lab lamppost laptop laundry lego microphone motorcycle mug necklaces newspaper observatory opera_house pet_store piano plush_toys policeman power_plant racing_car ring road_sign robot roller_skate scarf shopping_mall skateboarding skiing skyscraper soccer soldier stadium statue subway supermarket surfing swimming table_tennis temple tennis tie tractor train umbrella vase vending_machine video_game violin volleyball watch zoo'
        args.data_train_path = '/projectnb/ivc-ml/amliu/clear/clear100/train_image_only/labeled_images'
        args.data_test_path = '/projectnb/ivc-ml/amliu/clear/clear100/test/labeled_images'
        args.data_folder_path = '/projectnb/ivc-ml/amliu/clear/clear100/train_image_only/labeled_images'
        args.num_instance_each_class = 100
...
class Clear100Group(Clear100Base):
    def __init__(self, args):
        super().__init__(args=args)
